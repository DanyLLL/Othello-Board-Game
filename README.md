...
- Custom Data Structures & Matrices : Built a custom LIFO stack (Pile) to determine for move history tracking, and managed dual 2D arrays to efficiently separate the logical board state from the visual Tkinter objects.
- GUI & Event-Driven Programming : Used tkinter to build an interactive graphical interface, dynamically generate and destroy actionable buttons based on the rules of Otheelo, and bind lambda functions to give specific grid coordinates to button commands.
